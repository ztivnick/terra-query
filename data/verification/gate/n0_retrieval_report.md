...
Generated at: 2026-05-21T19:31:32.084326+00:00
...
No recall metric for these (no labeled feature in the eval set). Open the thumbnail folders under `verification/gate/topk_chips/` to inspect:

- **mine_pit**
  - `verification/gate/topk_chips/mine_pit__georsclip-vit-l-14-336__rgb`

- **cliff_outcrop**
  - `verification/gate/topk_chips/cliff_outcrop__georsclip-vit-l-14-336__rgb`

- **old_logging_road**
  - `verification/gate/topk_chips/old_logging_road__georsclip-vit-l-14-336__rgb`

- **river_rapids**
  - `verification/gate/topk_chips/river_rapids__georsclip-vit-l-14-336__rgb`
